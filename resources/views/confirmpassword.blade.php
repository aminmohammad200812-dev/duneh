...
<title>تایید کد</title>
    <div class="container">
        ...
        <form id="resetForm" autocomplete="off">
            ...
            <p id="message"></p>
            <a href = '{{url('index')}}' id="mobileCorrection">اصلاح شماره موبایل</a>
    ...
    <script>
        ...
        // document.getElementById("mobileCorrection"){
  ...
  document.getElementById("textInput").value = pendingUser.username || "";
  document.getElementById("phoneNumber").value = pendingUser.phone || "";

  // پسوردها رو خالی بذاریم برای امنیت
